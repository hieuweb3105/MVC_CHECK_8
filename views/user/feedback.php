<div class="container d-flex justify-content-center p-3">
    <div class="col-12 col-md-6 col-lg-5 bg-dark bg-opacity-75 text-light rounded-3 py-5 px-3 px-lg-5 text-center">
        ...
        <form action="" method="post">
            <label for="range" class="form-label">Mức điểm đánh giá / Point</label>
            ...
            <button disabled class="btn btn-dark shadow" id="sendBtn" name="sendBtn" type="submit">Gửi đi / Sent</button>
        </form>
    </div>
</div>
